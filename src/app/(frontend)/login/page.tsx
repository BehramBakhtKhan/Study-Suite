...
import { LoginSchema, type LoginInput } from "@/lib/validatons/auth/auth";
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl backdrop-blur-sm">
        ...
        <header className="mb-8 text-center">
          ...
          <p className="text-sm text-slate-400 mt-2">
            Sign in to access your Study Suite workspace
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            {errors.email && (
              <p id="email-error" role="alert" className="text-xs font-medium text-red-400 mt-1">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                {...register("password")}
                placeholder="••••••••"
                className={`w-full left-0 pr-11 pl-4 py-2.5 rounded-lg bg-slate-800/60 border text-white placeholder-slate-500 transition-all duration-200 focus:outline-none focus:ring-2 hover:border-slate-600 ${errors.password
                    ? "border-red-500/80 focus:ring-red-500/80 focus:border-red-500"
                    : "border-slate-700/80 focus:ring-indigo-500/80 focus:border-indigo-500 focus:bg-slate-800"
                  }`}
              />
            ...
            {errors.password && (
              <p id="password-error" role="alert" className="text-xs font-medium text-red-400 mt-1">
